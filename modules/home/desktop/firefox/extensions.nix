{ buildMozillaXpiAddon, fetchurl, lib, stdenv }:
  {
    ...
    "market-app" = buildMozillaXpiAddon {
      pname = "market-app";
      version = "1.9.0";
      addonId = "admin@csgo.com";
      url = "https://addons.mozilla.org/firefox/downloads/file/4875375/market_app-1.9.0.xpi";
      sha256 = "c962619c8d53064a229f041eb861f312515e5e787eb7d775996ed3ce3b6b2b1c";
      meta = with lib;
      {
        homepage = "https://market.csgo.com/";
